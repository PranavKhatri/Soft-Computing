...
print()
print("Decoded value of C:", Decoded_X)
print("Decoded value of gamma:", Decoded_Y)
...
Min_for_all_Generations_for_Mut_1_2 = np.empty((0,len(XY0)+2))
...
for i in range (gen):
    ...
    Final_Best_in_Genration=[]
    Worst_Best_in_Genration=[]
